...
--
myWorkspaces    = ["term","web","com","music","5","6","7","8","9"]

-- Border colors for unfocused and focused windows, respectively.
--
myNormalBorderColor  = "#292f36"
myFocusedBorderColor = "#71f79f"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- (("<XF86AudioLowerVolume>"), "spawn --no-startup-id pactl set-sink-volume 0 +5%")
...
myStartupHook = do
    ...
    spawnOnce "spotify &"
    -- spawnOnce "compton --config ~/.config/i3/compton.conf &"
